...
# i2a_tools_redhat, ...). Builds the configured Liberty image and the Solr init image,
# then pushes to ACR.
# Reference: https://github.com/i2group/analyze-deployment-tooling
source "$(dirname "$0")/00-common.sh"
: "${ACR:?}"; : "${I2_VERSION:?}"; : "${ADT_VERSION:?}"
...
for img in "liberty_configured_redhat:${CONFIG_NAME}-${I2_VERSION}" "solr_redhat:${I2_VERSION}" \
           "solr_client_redhat:${I2_VERSION}" "i2a_tools_redhat:${I2_VERSION}"; do
