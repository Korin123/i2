...
// Generated by scripts/10-deploy-infra.sh (or reused from Key Vault) and passed in the
// environment - never written here.
param sqlMiAdminPassword = readEnvironmentVariable('SQL_MI_ADMIN_PASSWORD', '')
